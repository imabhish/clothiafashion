                            ...
                            <div className="flex-1 py-2 px-3">
                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    {Array(1).fill("").map((el, i) => (
                                        ...
                                        <span className="font-medium ml-2">Bank Offer</span> 15% Instant discount on first Clothia Pay Later order of 500 and above <Link className="text-primary-blue font-medium" to="/">T&C</Link>
                                        </p>
                                    ))}
                                    {/* <!-- banks offers --> */}
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between">
                                        ...
                                        <div className="flex gap-16 mt-4 mr-6 items-stretch text-sm">
                                            ...
                                            <ul className="flex flex-col gap-2">
                                                <li>
                                                    <p className="flex items-center gap-3"><span className="text-primary-blue"><VerifiedUserIcon sx={{ fontSize: "18px" }} /></span> {product.warranty} Months</p>
                                                </li>
                                                <li>
